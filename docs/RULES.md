...
> [!NOTE]
> 본 문서는 공통 AI 협업 운영 지침서입니다. HWP Batch Printer 프로젝트에 특화된 아키텍처 원칙, COM 객체 제어 정책 및 프로젝트 의사결정 히스토리는 [PROJECT_GUIDE.md](file:///c:/Coding/Projects/Personal/hwp_batch_printer/docs/PROJECT_GUIDE.md)를 함께 참조하여 최우선으로 준수해야 합니다.
